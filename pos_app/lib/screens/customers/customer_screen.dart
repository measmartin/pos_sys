...
class _CustomerScreenState extends State<CustomerScreen> {
  ...
  SliverAppBar _buildAppBar(BuildContext context, CustomerProvider provider) {
  ...
  Widget _buildContent(BuildContext context, CustomerProvider provider) {
    ...
    return SliverList(
      delegate: SliverChildBuilderDelegate(
        (_, i) => CustomerCard(
          customer: list[i],
          onTap: () => _showCustomerDetail(context, list[i]),
        ),
  ...
  void _showCustomerDetail(BuildContext context, CustomerDetailsDto customer) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (_) => CustomerDetailSheet(customer: customer),
    );
  }
}
